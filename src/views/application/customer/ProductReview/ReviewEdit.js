...
const ReviewEdit = ({ open, handleCloseDialog, edit }) => {
    ...
    return (
        ...
        >
            {open && (
                <>
                    {edit ? <DialogTitle>Edit Review</DialogTitle> : <DialogTitle>Add Review</DialogTitle>}
                    <DialogContent>
                    ...
                    <DialogActions>
                        <AnimateButton>
                            {edit ? <Button variant="contained">Edit</Button> : <Button variant="contained">Create</Button>}
                        </AnimateButton>
