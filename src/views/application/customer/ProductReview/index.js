...
const ProductReviewList = () => {
    ...
    const handleEditClickOpenDialog = () => {
        setEdit(true);
        setOpen(true);
    };
    ...
    return (
        <MainCard title="Project List" content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={24} sm={24} sx={{ textAlign: 'right' }}>
                        {/* <Tooltip title="Copy">
                            <IconButton size="large">
                                <FileCopyIcon />
                            </IconButton>
            ...
            <TableContainer>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center" sx={{ pr: 3 }}>
                                            ...
                                            <IconButton color="secondary" onClick={handleEditClickOpenDialog} size="large">
                ...
                <ReviewEdit
                    ...
                    edit={edit}
                    // handleEditClickCloseDialog={handleEditClickCloseDialog}
                />
            </TableContainer>
